...
By contributing, you agree that your contributions will be licensed under its [MIT License](LICENSE). _(Ensure you have a `LICENSE` file, typically MIT for open-source starters)_
